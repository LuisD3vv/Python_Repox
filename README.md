...
## Repositorio de python Open Source
...
>[!NOTE]
>Todo el contenido que está en este repositorio, es gracias al curso de [Udemy](https://www.udemy.com/course/python-total/) llamado "Python Total en 16 dias" de Federico Garay, todos los creditos correspondientes a su creador, pero en lo que aqui nos conscierne es aprender python desde la raiz hasta poder trabajar con archivos y paginas, y otros proyectos que por si solos requieren repositorios propios, ya veces uno que otro marco de desarrollo.

>[!NOTE]
> Todos los proyectos aquí subidos son meramente de aprendizaje.

>[!NOTE]
>Cabe resaltar que no es un proyecto como tal, es un conjunto de proyectos que hacen un curso, por eso no tiene una estructura que un proyecto profesional tendria.

codigos y ejercicios hechos por mi (osea no los cree los hice pues)
