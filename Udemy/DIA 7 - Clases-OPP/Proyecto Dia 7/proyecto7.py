...
def inicio():
    ...
    print(f"Hola {cliente_actual.nombre}")
    while cliente_actual.balance > 0:
        ...
        if opcion == 1:
            ...
            try:
                ...
                print(f"Error: {error}")
                print(f"Puedes retirar un máximo de ${cliente_actual.balance} disponibles en la cuenta terminacion:[-{cliente_actual.numero_cuenta}-]")
        elif opcion == 3:
            system("clear")
