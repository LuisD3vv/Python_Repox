class Pajaro:
    ...
    def poner_huevos(cls, cantidad): # solo al cls, que es la clase misma en si, es decir puede acceder a los atributos de clase
        print(f"Puso {cantidad} de huevos")
        cls.alas = False
        print(Pajaro.alas)

    @staticmethod # No puede acceder a ningun atributo, ni a la clase, pero tiene relacion logica con ella
    def mirar():
