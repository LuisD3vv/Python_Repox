...
siRecetasExiste = Path("A_Udemy/DIA 6 - Rutas y gestion archivos/Recetas") # queremos comprobar que exista la carpeta RECETAS
...
ruta = Path.home() / "Python_Repox/A_Udemy/DIA 6 - Rutas y gestion archivos/Recetas"
