# -*- coding: utf-8 -*-
"""Copy of Python TOTAL - Machine Learning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xutfG0ZGjA3VvL22arBHsH1Ba9uu-uU5
...
# creamos un gráfico para la matriz de confusión (usando display, es diferente al curso)
ConfusionMatrixDisplay.from_estimator(arbol, X, y, cmap=plt.cm.Blues)
# plt.show()
...
columnas =X.columns
# creamos el gráfico, especifciando x e y
